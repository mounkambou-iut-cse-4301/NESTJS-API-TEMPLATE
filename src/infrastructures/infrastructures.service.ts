...
//     const existing = await tx.infrastructure.findMany({
//       where: { id_parent: parentId },
//       select: { id: true, name: true, type: true, description: true, location: true, images: true, attribus: true },
//     }) as Array<{ id: bigint; name: string; type: string; description: string | null; location: any; images: any; attribus: any }>;
//     const byId = new Map<string, typeof existing[number]>(existing.map(e => [toStrId(e.id), e]));
//     const used = new Set<string>();
//     const enriched: any[] = [];
